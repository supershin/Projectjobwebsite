...
- **User ทั่วไป** - ค้นหางาน, สมัครงาน, บันทึกงาน, ดูสถานะใบสมัคร
- **User Employer** - ลงประกาศงาน, จัดการตำแหน่งงาน, ดูผู้สมัคร, ชำระเงิน
- **Admin** - จัดการผู้ใช้, นายจ้าง, งาน, ระบบทั้งหมด
...
- ✅ ระบบ Dashboard แยกตามประเภทผู้ใช้ (URL-based)
- ✅ ระบบ Multi-Language (Thai-English) พร้อม Language Switcher
- ✅ ระบบแสดงสวัสดิการด้วย Badge ที่สวยงาม
- ✅ Charts และ Graphs สำหรับสถิติ (Chart.js)
- ✅ ระบบคิดค่าบริการต่อ 1 post (299 บาท/30 วัน)
...
```
GET    /api/jobs              - ดึงรายการงานท���้งหมด
